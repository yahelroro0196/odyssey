defmodule OdysseyElixir.Config.Schema do
  @moduledoc false
  ...
  defmodule Workspace do
    ...
    @primary_key false
    embedded_schema do
      field(:root, :string, default: Path.join(System.tmp_dir!(), "odyssey_workspaces"))
  ...
  defp finalize_settings(settings) do
    ...
    workspace = %{
      settings.workspace
      | root: resolve_path_value(settings.workspace.root, Path.join(System.tmp_dir!(), "odyssey_workspaces")),
        source_repo: resolve_optional_path(settings.workspace.source_repo)
    }
  ...
  defp expand_local_workspace_root(_workspace_root) do
    Path.expand(Path.join(System.tmp_dir!(), "odyssey_workspaces"))
  end
