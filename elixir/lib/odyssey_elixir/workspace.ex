defmodule OdysseyElixir.Workspace do
  @moduledoc """
  Creates isolated per-issue workspaces for parallel Codex agents.
  """

  require Logger
  alias OdysseyElixir.{Config, PathSafety, SSH}

  @remote_workspace_marker "__ODYSSEY_WORKSPACE__"
  ...
  defp maybe_create_worktree(workspace, issue_context, true, nil) do
    case Config.settings!().workspace.source_repo do
      nil -> :ok
      source_repo -> create_worktree(source_repo, workspace, "odyssey/#{issue_context.issue_identifier}")
    end
  end
