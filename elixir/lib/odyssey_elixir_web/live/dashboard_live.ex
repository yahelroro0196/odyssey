defmodule OdysseyElixirWeb.DashboardLive do
  @moduledoc """
  Live observability dashboard for Odyssey.
  """
    ...
    <section class="dashboard-shell">
      <header class="hero-card">
        <div class="hero-grid">
          <div>
            <p class="eyebrow">
              Odyssey Observability
            </p>
            <h1 class="hero-title">
              Operations Dashboard
            </h1>
            <p class="hero-copy">
              Current state, retry pressure, token usage, and orchestration health for the active Odyssey runtime.
            </p>
          </div>
  ...
  defp load_config_reload_status do
    case Process.whereis(OdysseyElixir.WorkflowStore) do
      pid when is_pid(pid) -> OdysseyElixir.WorkflowStore.reload_status()
